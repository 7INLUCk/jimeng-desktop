...
2. 明确每个 @引用素材的职责，不混用
3. 保持简洁，不要冗余描述
4. 有视频素材时，强调「参考 @视频N 的动作/运镜」
5. 有图片素材时，强调「保持 @图片N 的形象/背景」
...
输出：
{
  "prompt": "使用 @图片1 作为人物形象和场景参考，保持人物外貌、穿着和背景完全不变。参考 @视频1 的舞蹈动作和运镜方式，流畅完成整套舞蹈。人物每2-3秒自然眨眼。",
...
输出：
{
  "prompt": "使用 @图片1 作为人物参考，保持人物外貌和背景不变。人物穿着换成 @图片2 中的衣服。参考 @视频1 的舞蹈动作和运镜。",
...
输出：
{
  "prompt": "以 @图片1 的风景场景为背景，根据 @音频1 的音乐节奏进行画面切换和动态展示。",
